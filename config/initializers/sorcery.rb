...
Rails.application.config.sorcery.configure do |config|
  ...
  #
  config.vk.key = Rails.configuration.vk_key
  config.vk.secret = Rails.configuration.vk_secret
  config.vk.callback_url = "http://#{Rails.configuration.app_host}/oauth/callback?provider=vk"
  config.vk.user_info_mapping = {name: "full_name", photo: 'photo_100'}
  config.vk.scope = 'friends'
  #
